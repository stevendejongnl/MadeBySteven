...
const backgroundColor = r$4('#282A36');
const foregroundColor = r$4('#F8F8F2');
const textColor = r$4('#8BE9FD');
const promptColor = r$4('#50FA7B');
const cursorColor = r$4('#44475A');
const borderColor = r$4('#44475A');
const MbsColorScheme = {
    background: i$3 `var(--mbs-color-scheme-background, ${backgroundColor})`,
    foreground: i$3 `var(--mbs-color-scheme-foreground, ${foregroundColor})`,
    text: i$3 `var(--mbs-color-scheme-text, ${textColor})`,
    prompt: i$3 `var(--mbs-color-scheme-prompt, ${promptColor})`,
    cursor: i$3 `var(--mbs-color-scheme-cursor, ${cursorColor})`,
    border: i$3 `var(--mbs-color-scheme-border, ${borderColor})`
};
...
let MbsLayoutBase = class MbsLayoutBase extends i {
    render() {
        return x `
      <main>
        <slot></slot>
...
Object.defineProperty(MbsLayoutBase, "styles", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: styles$2
});
MbsLayoutBase = __decorate([
    t('mbs-layout-base')
], MbsLayoutBase);
...
let MbsHeading = class MbsHeading extends i {
    constructor() {
        super(...arguments);
        Object.defineProperty(this, "displayedText", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: ''
        ...
        Object.defineProperty(this, "fullText", {
            ...
            configurable: true,
            writable: true,
            value: 'Made by Steven'
        });
        Object.defineProperty(this, "typingTimeout", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
Object.defineProperty(MbsHeading, "styles", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: styles$1
...
__decorate([
    r()
], MbsHeading.prototype, "displayedText", void 0);
MbsHeading = __decorate([
    t('mbs-heading')
], MbsHeading);
...
let MbsMainTerm = class MbsMainTerm extends i {
    constructor() {
        super(...arguments);
        Object.defineProperty(this, "displayedText", {
            enumerable: true,
...
Object.defineProperty(MbsMainTerm, "styles", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: styles
...
__decorate([
    r()
], MbsMainTerm.prototype, "displayedText", void 0);
MbsMainTerm = __decorate([
    t('mbs-main-term')
], MbsMainTerm);

export { MbsHeading, MbsLayoutBase, MbsMainTerm };
